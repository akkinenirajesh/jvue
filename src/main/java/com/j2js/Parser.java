...
public class Parser {
    ...
    public TypeDeclaration parse() {
        ...
        TypeDeclaration typeDecl = new TypeDeclaration(type,
                jc.getAccessFlags());
        ...
        if (!type.getClassName().equals("java.lang.Object")) {
            ...
            ClassUnit superUnit = Project.getSingleton()
                    .getOrCreateClassUnit(superType.getClassName());
            ...
            for (int i = 0; i < interfaceNames.length; i++) {
                ...
                ClassUnit interfaceUnit = Project.getSingleton()
                        .getOrCreateClassUnit(interfaceType.getClassName());
        ...
        for (int i = 0; i < bcelMethods.length; i++) {
            ...
            MethodDeclaration methodDecl = new MethodDeclaration(binding,
                    method.getAccessFlags(), method.getCode());
    ...
    public void parseMethod(TypeDeclaration typeDecl,
            MethodDeclaration methodDecl, Method method) {
        ...
        for (int i = 0; i < types.length; i++) {
            ...
            variableDecl.setName(VariableDeclaration
                    .getLocalVariableName(method, offset, 0));
        ...
        try {
            ...
            MethodBinding binding = MethodBinding.lookup(
                    "java.lang.RuntimeException", "<init>",
                    "(java/lang/String)V;");
            ClassInstanceCreation cic = new ClassInstanceCreation(methodDecl,
                    binding);
            cic.addArgument(
                    new StringLiteral("Unresolved decompilation problem"));
