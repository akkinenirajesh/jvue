...
public class Pass1 {
	...
	private void compileCodeException() {
		...
		while (handle != null) {
			...
			if (catches.getChildCount() == 0) {
				throw new ParseException("A try clause must have at least one (possibly default) catch clause",
						tryStmt);
			}
	...
	public void parseStatement() throws IOException {
		...
		while (bytes.available() > 0) {
			...
			logger.debug(" -> " + stmt + " @ " + methodDecl.getLineNumberCursor().getLineNumber(stmt) + ", depth:"
					+ depth + ", delta:" + stmt.getStackDelta());
	...
	private VariableBinding createVariableBinding(int slot, Type type, boolean isWrite) {
		return methodDecl.createVariableBinding(
				VariableDeclaration.getLocalVariableName(method, slot, bytes.getIndex()), type, isWrite);
	}
	...
	private ASTNode parseInstruction() throws IOException {
		...
		case Const.LSHR:
			...
			instruction = createInfixRightLeft(InfixExpression.Operator.RIGHT_SHIFT_SIGNED, stack.pop(), stack.pop(),
					form.getResultType());
			break;
		...
		case Const.LSHL:
			// Format: lshl
			// Operand stack: ..., value1(), value2() -> ..., result(long)
			instruction = createInfixRightLeft(InfixExpression.Operator.LEFT_SHIFT, stack.pop(), stack.pop(),
					form.getResultType());
			break;
		...
		case Const.LUSHR:
			// Format: lushr
			// Operand stack: ..., value1(), value2() -> ..., result(long)
			instruction = createInfixRightLeft(InfixExpression.Operator.RIGHT_SHIFT_UNSIGNED, stack.pop(), stack.pop(),
					form.getResultType());
			break;
		...
		case Const.DADD:
			...
			// result(double)
			instruction = createInfixRightLeft(InfixExpression.Operator.PLUS, stack.pop(), stack.pop(),
					form.getResultType());
			break;
		...
		case Const.DSUB:
			...
			// Operand stack: ..., value1(double), value2(double) -> ...,
			// result(double)
			instruction = createInfixRightLeft(InfixExpression.Operator.MINUS, stack.pop(), stack.pop(),
					form.getResultType());
			break;
		...
		case Const.DMUL:
			...
			instruction = createInfixRightLeft(InfixExpression.Operator.TIMES, stack.pop(), stack.pop(),
					form.getResultType());
			break;
		...
		case Const.DDIV:
			// Format: ddiv
			// Operand stack: ..., value1(), value2() -> ..., result(double)
			instruction = createInfixRightLeft(InfixExpression.Operator.DIVIDE, stack.pop(), stack.pop(),
					form.getResultType());
			break;
		...
		case Const.DREM:
			// Format: drem
			// Operand stack: ..., value1(), value2() -> ..., result(double)
			instruction = createInfixRightLeft(InfixExpression.Operator.REMAINDER, stack.pop(), stack.pop(),
					form.getResultType());
			break;
		...
		case Const.LXOR:
			// Format: lxor
			// Operand stack: ..., value1(), value2() -> ..., result(long)
			instruction = createInfixRightLeft(InfixExpression.Operator.XOR, stack.pop(), stack.pop(),
					form.getResultType());
			break;
		...
		case Const.LAND:
			// Format: land
			// Operand stack: ..., value1(), value2() -> ..., result(long)
			instruction = createInfixRightLeft(InfixExpression.Operator.AND, stack.pop(), stack.pop(),
					form.getResultType());
			break;
		...
		case Const.LOR:
			// Format: lor
			// Operand stack: ..., value1(), value2() -> ..., result(long)
			instruction = createInfixRightLeft(InfixExpression.Operator.OR, stack.pop(), stack.pop(),
					form.getResultType());
			break;
		...
		case Const.POP2: {
			...
			if (opcode == Const.POP2 && form.getIndex() == 1) {
				throw new UnsupportedOperationException(
						"InstructionType " + instructionType.getName() + " not supported");
			}
	...
	ConditionalBranch createConditional(int currentIndex, InfixExpression.Operator operator, Expression rightOperand)
			throws IOException {
		ConditionalBranch c = new ConditionalBranch(currentIndex + bytes.readShort());
