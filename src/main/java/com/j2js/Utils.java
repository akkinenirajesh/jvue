...
public final class Utils {
	...
	// if (!dir.isDirectory()) {
	// throw new RuntimeException("Package " + signature + " could not be
	// resolved");
	// }
	...
	/**
	 * If path is absolute, returns the file with the given path. Otherwise
	 * returns the file with path resolved against baseDir.
	 */
